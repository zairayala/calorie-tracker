...
type ActivityListProps = {
    activities: Activity[] //es un arreglo de activitys
...
export default function ActivityList({ activities, dispatch }: ActivityListProps) {
    ...
    const isEmptyActivities = useMemo(() =>activities.length === 0 ,[activities]) //este usememo devuelve true o false, y cambia cuando cambia activities
